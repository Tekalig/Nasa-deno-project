...
import {
  BsFillCalendarCheckFill as UpdateIcon,
  BsFillClockFill as HistoryIcon,
  BsFillGearFill as FaviconIcon,
  BsFillRocketTakeoffFill as LaunchIcon,
} from "react-icons/bs";
      ...
      <Centered className="flex flex-row items-center justify-evenly h-20">
        ...
        <nav className="flex">
          <Clickable className="text-lg">
            <div className="px-2">
              <Link
                className="no-underline flex flex-col justify-center items-center text-green-600"
                to="/launch"
              >
          ...
          <Clickable className="text-lg">
            <div className="px-2">
              <Link
                className="no-underline flex flex-col justify-center items-center text-orange-600"
                to="/upcoming"
              >
                <i className="mr-2 text-xl">
                  <UpdateIcon />
          ...
          <Clickable className="text-lg">
            <div className="px-2">
              <Link
                className="no-underline flex flex-col justify-center items-center text-red-600"
                to="/history"
              >
                <i className="mr-2 text-xl">
                  <HistoryIcon />
